...
from pipelines.models import Provider, PipelineTemplate, JobTemplate, PipelineInstance, JobInstance
...
class PipelineTemplateModelTest(TestCase):
    ...
    def test_pipeline_template_versioning(self):
        ...
        # Second version
        second_version = PipelineTemplate.objects.create(
        ...
        templates = PipelineTemplate.objects.filter(name="Versioned Pipeline").order_by('version')
